...
public class DeleteArbolVistoAsync (private val arbolVistoDao: ArbolVistoDAO, private val call: String) : AsyncTask<ArbolVisto, Void, ArbolVisto>() {

  override fun doInBackground(vararg arbolVisto: ArbolVisto?): ArbolVisto? {
      return try {
          arbolVistoDao.delete(arbolVisto[0]!!)
          arbolVisto[0]!!
      } catch (ex: Exception) {
          null
      }
